...
def get_employees_engineering_high_salary():
    try:
        return qury.get_engineering_high_salary_employees()
...
def get_employees_by_age_and_role():
    try:
        return qury.get_employees_by_age_and_role()
    except HTTPException as e:
        return str(e)
...
def get_employees_top_seniority():
    try:
        return qury.get_top_seniority_employees_excluding_hr()
    except HTTPException as e:
        return str(e)
...
def get_employees_age_or_seniority():
    try: 
        return qury.get_employees_by_age_or_seniority()
    except HTTPException as e:
        return str(e)
...
def get_employees_managers_excluding_departments():
    try:
        return qury.get_managers_excluding_departments()
    except HTTPException as e:
        return str(e)
...
def get_employees_by_lastname_and_age():
    try: 
        return qury.get_employees_by_lastname_and_age()
    except HTTPException as e:
        return str(e)